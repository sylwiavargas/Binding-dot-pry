...
quotes_arr = [
    ...
    {content: "All movies aren't fun; some are hard work. You try to do something and convey a set of emotions that have to do with some real life kind of stuff.", person_id: samuel.birth},
